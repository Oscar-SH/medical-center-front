...
const CmpRolesFilters = () => {
    ...
    const handleRestoreFilters = () => {
        dispatch(changeTablePersonPermissions(initParamsRoleInterface));
    };
...
export default CmpRolesFilters;